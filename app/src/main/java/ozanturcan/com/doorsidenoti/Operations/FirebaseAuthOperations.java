...
import ozanturcan.com.doorsidenoti.LoginActivity;
...
public class  FirebaseAuthOperations extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void FirebaseSignInMethod(String email, String password) {
    ...
    protected void updateUI(FirebaseUser user) {
        ...
        MyUserInfo.setPersonEmail(personEmail);
        MyUserInfo.setPersonName(personName);
        MyUserInfo.setPersonPhoto(personPhoto);

            TextView text = (TextView) findViewById(R.id.NavHead__UserName);
            TextView text2 = (TextView) findViewById(R.id.NavHead_UserMail);
    ...
    protected void intenttoNewForm() {
