...
public class FirebaseDatabaseOperations extends AppCompatActivity{
    ...
    public void sendTokenMessage(HashMap<String,String> list){
        final DatabaseReference databaseReference = mDatabase.child("Devices").child(UserInfo.getPersonDeviceIDs())
                .child("TokenProps").child(deviceInfo.getCurrentToken());
